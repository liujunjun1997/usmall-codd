<template>
  <div>
    ...
    >
      <el-table-column prop="id" label="分类编号" width="180px"></el-table-column>
      <el-table-column prop="catename" label="分类名称" width="180px"></el-table-column>
      <el-tabel-column label="图片">
